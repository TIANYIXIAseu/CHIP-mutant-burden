...
infile  <- "search_terms_data_gene.csv"
chipfile <- "20251211_chip.csv"
past_out <- "20251211_past_data.csv"
future_out <- "20251211_future_data.csv"
summary_out <- "20251211_non_na_summary.csv"
